...
class MarketCapCalculator(AnalyticsCalculator):
    """
    ...
    def __init__(self):
        ...
        super().__init__("market_cap", "market_cap", is_fundamental=True)
    ...
    def calculate(self, asset_data):
        ...
        self.fundamental_data = market_cap_data
        self.analytics_data = market_cap_data
